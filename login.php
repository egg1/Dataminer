...
<html>
	<head profile="http://gmpg.org/xfn/11">
    	<title>Broadening Participation in Data Mining - Administrative Login</title>
    ...
    <body onload="siteLoaded()">
        ...
        <article>
        	<div id="screen-content">
                ...
                <form id="form0" action="passThru/login.php" method="post">
                    <fieldset style="width:250px;">
                        <label for="username"><b>* </b>Username: <input id="username" name="username" maxlength="25" type="text" /></label><br /><br />
