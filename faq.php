...
<html>
	<head profile="http://gmpg.org/xfn/11">
    	<title>Broadening Participation in Data Mining - Frequently Asked Questions</title>
        ...
        <meta name="keywords" content="data mining workshop machine learning text mining database high performance computing BPDM BPDM12 BPDM2012 BPDM13 BPDM2013"/>
        ...
        <script type="text/javascript">
        	function siteLoaded()
			{
				...
				$.ajax({type:"GET",url:"content/faq.html",dataType:"html",cache:false,success:function(data){data = replaceData(data);$("#screen-content").html(data);}});
