...
<html>
	<head profile="http://gmpg.org/xfn/11">
    	<title>Broadening Participation in Data Mining - Live Stream Presentations</title>
        ...
        <script type="text/javascript">
        	function siteLoaded()
			{
				...
				$.get("content/liveStream.html",function(data){data = replaceData(data);$("#screen-content").html(data);});
