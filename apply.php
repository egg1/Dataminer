...
<html>
	<head profile="http://gmpg.org/xfn/11">
    	<title>Broadening Participation in Data Mining - Apply</title>
        ...
        <script type="text/javascript">
        	function siteLoaded()
			{
				...
				$.ajax({type:"GET",url:"content/apply.html",dataType:"html",cache:false,success:function(data){data = replaceData(data);$("#screen-content").html(data);}});
