...
<html>
	<head profile="http://gmpg.org/xfn/11">
    	<title>Broadening Participation in Data Mining - Contact</title>
        ...
        <script type="text/javascript">
        	function siteLoaded()
			{
				...
				$.ajax({type:"GET",url:"content/membership locations.html",dataType:"html",cache:false,success:function(data){data = replaceData(data);$("#screen-content").html(data);}});
