...
$sql = "SELECT AdminID, FirstName, LastName, Email, AdminType FROM Admin WHERE AdminID='".$userName."' AND Password='".$password."'"; // create the sql statement
